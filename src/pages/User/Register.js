        ...
        <div className="flex flex-col h-screen bg-gray-100">
            ...
            bg-white rounded-lg shadow-md lg:shadow-lg">
                    ...
                    <form className="mt-10" onSubmit={handleSubmit}>
                        <label htmlFor="email" className={"block text-xs font-semibold uppercase "+(emailChecker? 'text-red-500': 'text-gray-800')}>E-mail</label>
                        <input id="email" name="email" placeholder="e-mail address" onChange={(e) => {
                            ...
                            required />
                        <label htmlFor="username" className={"block text-xs font-semibold text-gray-600 uppercase "+(usernameChecker? 'text-red-500': 'text-gray-800') }>Username</label>
